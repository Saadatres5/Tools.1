  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fff" }}>
      ...
      <section style={{ background: "linear-gradient(180deg,#f8fafc 0%,#fff 100%)", padding: "80px 24px 64px", textAlign: "center", borderBottom: "1px solid #e2e8f0" }}>
        ...
        {/* Quick links — CSS class only, no JS handlers */}
      ...
      <main style={{ maxWidth: 1280, margin: "0 auto", padding: "52px 24px 80px" }}>
        ...
        {/* Client component handles tabs + grid (event handlers allowed there) */}
        <HomepageTools />
        ...
        <div style={{ background: "#0f172a", borderRadius: 20, padding: "52px 48px", marginBottom: 48 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))", gap: 20 }}>
            {[
              { icon: "🔒", title: "Privacy First", desc: "Files processed in your browser. Nothing uploaded to our servers." },
              ...
              { icon: "🤖", title: "AI-Powered", desc: "Smart AI tools in your browser — no API keys, no cost." },
            ].map(f => (
        ...
        {/* ── ALL CATEGORIES — CSS class hover, no JS ── */}
        ...
        {/* ── CTA — CSS classes for hover, no JS handlers ── */}
