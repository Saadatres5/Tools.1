  ...
  return (
    <div className="space-y-5">
      <div className="text-center py-8 space-y-4">
        <div className={`w-28 h-28 rounded-2xl mx-auto flex flex-col items-center justify-center transition-all ${recording?"bg-red-500/20 border-2 border-red-500":"bg-gray-50 border-2 border-gray-200"}`}>
        ...
        {recording && <p className="text-red-600 text-sm animate-pulse">● Recording screen...</p>}
        {!recording && <p className="text-gray-400 text-xs">Choose to share your screen, a window, or a browser tab</p>}
      </div>
      {recordings.length > 0 && (
