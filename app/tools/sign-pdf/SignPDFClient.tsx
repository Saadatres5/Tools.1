        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="text-sm text-gray-8000">Draw your signature</label>
              <button onClick={clear} className="text-xs text-gray-400 hover:text-gray-8000">Clear</button>
            </div>
            ...
            <p className="text-xs text-gray-400 mt-1">Sign inside the box above</p>
          </div>
          {status==="done" ? (
            <div className="p-4 rounded-2xl bg-green-50 border border-green-200 space-y-3">
              <p className="text-emerald-700 font-semibold">✅ Signature applied!</p>
            ...
            <div className="p-4 rounded-xl bg-red-50 border border-red-200 text-red-600 text-sm">❌ Failed to apply signature.</div>
          ) : (
